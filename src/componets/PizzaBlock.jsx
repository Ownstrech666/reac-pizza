...
//это не обязательно, и не всегда используется, проверка типов, isRequired - обязательно указанный тип
//иначе можно передать undefined/null
//это что б отлавливать ошибки, иначе там может быть что угодно, могут быть баги (ошибки в базе и т.д.)
